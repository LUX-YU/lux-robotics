...
int main(int argc, char* argv[])
{
    ...
    Rosbag rosbag("G:\\Resource\\DataSet\\SLAM\\The EuRoC MAV Dataset\\V1_01_easy\\V1_01_easy.bag");
    ...
    for(size_t i = 0; !rosbag.eof() && i < max_count ; i++)
    {
        ...
        record.TsearchHeader(
            [](const char* name, size_t name_len, const uint8_t* data, size_t data_len)
            {
